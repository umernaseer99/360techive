...
type NodeId = "support" | "sales" | "finance" | "research" | "document" | "assistant";

type Node = {
  /** Also the key into `AiAutomation.Network.nodes` for label and task. */
  id: NodeId;
  icon: LucideIcon;
...
export function AgentNetworkVisual() {
  ...
  const t = useTranslations("AiAutomation.Network");
